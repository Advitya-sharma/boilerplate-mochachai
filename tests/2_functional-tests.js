...
suite("Functional Tests", function() {
  ...
  suite("Integration tests with chai-http", function() {
    ...
    suite("PUT /travellers", function() {
      ...
      test('send {surname: "Colombo"}', function(done) {
        ...
        chai
          ...
          .end(function(err, res) {
            ...
            assert.equal(
              res.type,
              "application/json", // I just replaced the " " with '' here and it worked
              "Response should be json"
            );
            assert.equal(
              res.body.name,
              "Cristoforo", // and also here
      ...
      // now submit the solution again, I've tested it, FCC accepted

      // all ok
      // above test is passing in the console, if this not passed in the FCC, there might be a problemm in the response.
      // code is ok
      // you can submit the same solution after 1 or 2 hours
  ...
  Browser.site = "https://q-a-fcc.glitch.me";
